...
export const metadata: Metadata = {
  ...
  description: 'Diabetes remission in Bachupally Hyderabad. We test FASTING INSULIN (not glucose) + HOMA-IR. 32yrs ethics-guided care, 35L patients, India #1 5K+ HOMA tests, pioneer cardio-obesity-metabolism. 25 apps built. Pioneer close monitoring → REMISSION.',
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://dr-muddus-mvp-miracle-value-proposition-2l36.onrender.com/images/labnotice4.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'Dr Muddu Nehru | Diabetologist Bachupally Hyderabad',
    description: '90 Day Diabetes Remission in Bachupally | 85% Success',
    images: ['https://dr-muddus-mvp-miracle-value-proposition-2l36.onrender.com/images/labnotice4.jpg'],
  },
};
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-500 p-6 rounded-r-lg">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Most clinics in Bachupally only check your blood sugar. We go deeper—testing fasting insulin levels and calculating HOMA-IR to identify the root cause of metabolic dysfunction. This precision approach is why we achieve 85% remission rates.
            </p>
          </div>
        </div>
      </section>
