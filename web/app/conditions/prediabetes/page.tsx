...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://dr-muddus-mvp-miracle-value-proposition-2l36.onrender.com/images/prediabetes-reversal-hyderabad.jpg',
        width: 1200,
        height: 630,
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/30 transform hover:scale-105 transition-transform duration-300">
              <Image
                src="/images/prediabetes-reversal-hyderabad.jpg"
