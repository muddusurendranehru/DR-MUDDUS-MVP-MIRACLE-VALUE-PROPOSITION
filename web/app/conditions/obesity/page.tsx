...
export const metadata: Metadata = {
  title: 'Obesity & Weight Loss Management in 90 Days | Dr. Muddu Surendra Nehru, MD - Hyderabad',
  description: 'Sustainable weight loss through metabolic remission program in Gachibowli, Hyderabad. Led by Professor Dr. Muddu Surendra Nehru, MD with 32+ years experience.',
};
    ...
    <div className="min-h-screen bg-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Obesity Management in Gachibowli – Dr. Muddu Surendra Nehru, MD
        </h1>
        <p className="text-gray-700 mb-6">
          Hyderabad's leading metabolic approach to sustainable weight loss, led by Professor Dr. Muddu Surendra Nehru, MD — 32+ years of clinical excellence in Gachibowli.
        </p>
