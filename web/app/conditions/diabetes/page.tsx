...
export const metadata: Metadata = {
  title: 'Diabetes Reversal in 90 Days | Dr. Muddu Surendra Nehru, MD - Hyderabad',
  description: 'Evidence-based diabetes remission program in Gachibowli, Hyderabad. Led by Professor Dr. Muddu Surendra Nehru, MD with 32+ years experience.',
};
    ...
    <div className="min-h-screen bg-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Diabetes Reversal in Gachibowli – Dr. Muddu Surendra Nehru, MD
        </h1>
        <p className="text-gray-700 mb-6">
          Hyderabad's leading metabolic remission program for Type 2 diabetes, led by Professor Dr. Muddu Surendra Nehru, MD — 32+ years of clinical excellence in Gachibowli.
        </p>
