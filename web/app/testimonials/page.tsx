...
const testimonials = [
  ...
  },
  {
    ...
    age: 45,
    gender: 'male',
    avatar_gradient: 'from-indigo-400 to-blue-500',
    avatar_emoji: '👨',
    photo_url: '/images/waist2.jpg',
    video_url: 'https://www.youtube.com/channel/UCf8avHrw6K07POXSIoKgHwg',
    quote: 'Diabetes, hypertension, and central obesity — I had it all. My waist was 124cm and doctors said I was a ticking time bomb. Dr. Muddu\'s metabolic program reversed my insulin resistance. My waist is now 98cm and I\'m off 3 medications!',
    metrics_before: { HOMA_IR: 9.5, BMI: 34.8, HbA1c: 8.2, waist_cm: 124, BP: '160/100' },
    metrics_after: { HOMA_IR: 2.2, BMI: 28.5, HbA1c: 5.9, waist_cm: 98, BP: '130/85' },
    completed_program: true,
    program_days: 90,
  },
  {
